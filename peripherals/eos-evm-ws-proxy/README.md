...
- `GENESIS_JSON`: full file path of evm genesis.json, defaults to 'eos-evm-genesis.json'. For Vaulta EVM mainnet, you can download a copy of genesis.json from https://github.com/VaultaFoundation/evm-public-docs/blob/main/mainnet-genesis.json.
