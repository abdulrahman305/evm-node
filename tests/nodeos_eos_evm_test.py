...
try:
    ...
    # Launch evm-node
    Utils.Print("===== laucnhing evm-node & evm-rpc =====")
    ...
    cmd = f"{eosEvmBuildRoot}/bin/evm-node --plugin=blockchain_plugin --ship-core-account=eosio.evm --ship-endpoint=127.0.0.1:8999 --genesis-json={genesisJson} --verbosity=10 --nocolor=1 --chain-data={dataDir}"
